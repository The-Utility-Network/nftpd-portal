...
const PortalHUD: React.FC<PortalHUDProps> = ({ onNavigate, currentView }) => {
    ...
    const navItems = [
        ...
        { id: 'Blacklist', icon: ShieldExclamationIcon, label: 'OPS' },
        { id: 'Mythology', icon: SparklesIcon, label: 'LORE' },
    ];

    const socialLinks = [
        { label: 'COLLECTION', url: 'https://digibazaar.io/base/collection/0x745Fb657041D7aCfed1d4873480C0394FF68C129', icon: GlobeAltIcon },
        { label: 'WHITEPAPER', url: 'https://walterwallet-km8sr6o.gamma.site/', icon: DocumentTextIcon },
        { label: 'ABOUT US', url: 'https://nftpd.org/', icon: MicrophoneIcon },
    ];
    ...
    return (
        <>
            ...
            <div className="fixed top-0 left-0 w-full z-[2000] px-3 md:px-6 py-2 flex justify-between items-center pointer-events-none">
                ...
                <div className="flex items-center space-x-2 md:space-x-4 pointer-events-auto">
                    <div className="flex flex-col">
                        ...
                        <span className="text-sm md:text-md font-bold text-white tracking-widest font-mono">NFTPD//PORTAL</span>
                    </div>
                </div>
                ...
                <div className="flex items-center space-x-2 md:space-x-6 pointer-events-auto">
                    ...
                    <div id="portal-connect-wrapper">
                        <ConnectButton
                            ...
                            connectModal={{
                                size: 'wide',
                                titleIcon: '/Medallions/NFTPD.png',
                                welcomeScreen: {
                                    title: 'Welcome to NFTPD',
            ...
            <div className="fixed bottom-4 md:bottom-8 left-1/2 transform -translate-x-1/2 z-[2000] pointer-events-auto max-w-[95vw]">
                ...
                */}
                <div className="flex items-center space-x-1 md:space-x-2 px-3 md:px-6 py-2 md:py-3 bg-black/60 backdrop-blur-xl border border-white/30 rounded-full shadow-[0_0_30px_rgba(255,255,255,0.1)] overflow-x-auto no-scrollbar">
